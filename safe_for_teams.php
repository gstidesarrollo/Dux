  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 hero-text my-4">
        ...
        <b style="color: #FFFFFF;font-family: Helvetica; font-size:16px;">Marco para el Desarrollo Ágil de Soluciones</b>
        <p class="hero-tagline" style="font-family: Helvetica; font-size:14px;">
          Seguramente tu empresa tiene o planea iniciativas de transformación digital comenzando por establecer laboratorios con células ágiles por lo cual se requieren "practitioners" en Agilidad.<br /><br />
          Si eres un desarrollador o implementador de soluciones y quieres formar parte los equipos o células SCRUM, es hora que aprendas y te profesionalices en Agilidad con SAFe, el framework más aceptado en el mundo para “Equipos de Equipos Ágiles”, <br />
          Conviértete en un Profesional Ágil en tu empresa y obtén el certificado SAFe 4 Practitioner (SP)</br><br />
          <img src="img/PlantillaSAFeforTeamsLANDINGpage-02.jpg" alt="" width="auto" height="auto">
        </p>
      </div>
  ...
  <div class="container">
   <div class="row mb-lg-4">
     <div class="col-sm-12 text-center">
       <img src="img/cursosmodulos-01.jpg" />
     </div>
   </div> <!-- END row-->
   <br />
    <div class="row">
   ...
   if (nombre === "") {
       ...
       $(".contact-message").stop(true).html('<i class="fa fa-warning"></i> Cual es su numero de telefono ?').css("color", "#ef4b4b");
             ...
             $.ajax({
                 ...
                 type: 'POST',
                 data: 'tipo=safe_for_teams&source='+source+'&medium='+medium+'&campaign='+campaign+'&term='+term+'&content='+content+'&nombre='+nombre+'&apellido='+apellido+'&empresa='+empresa+'&cargo='+cargo+'&correo='+correo+'&telefono='+telefono,

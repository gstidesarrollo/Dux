  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 hero-text my-4">
        ...
        <b style="color: #FFFFFF;font-family: Helvetica; font-size:14px;">LENGUAJE DE MODELADO ARCHIMATE PARA NEGOCIOS, APLICACIONES, TECNOLOGÍA e INTERNET DE LAS COSAS.</b>
        <p class="hero-tagline" style="font-family: Helvetica; font-size:14px;">
          Eres un Gerente de Negocio, TI o Arquitecto Empresarial  y necesitas definir o levantar la estrategia en metamodelo de tus arquitecturas de negocio, datos, aplicaciones y tecnología para comunicarlas y desplegarlas sobre un repositorio compartido en tu organización.<br />
          Eres un profesional de TI y necesitas conectar las aplicaciones, los datos y la tecnología con la capa de negocio para lograr trazabilidad, identificando dependencias y compartiéndolas con los equipos de trabajo<br />
          Certifícate con nosotros en la última versión de Archimate 3.0 para TOGAF y la "Internet de las Cosas" (IoT).<br />
          <br />
          <img src="img/platilla ArchiMateLANDINGpage-02.jpg" alt="" width="auto" height="auto">
        </p>
      </div>
  ...
  <div class="container">
   <div class="row mb-lg-4">
     <div class="col-sm-12 text-center">
       <img src="img/cursosmodulosArchimate_Mesadetrabajo.jpg" />
     </div>
   </div> <!-- END row-->
   <br />
    <div class="row">
   ...
   if (nombre === "") {
       ...
       $(".contact-message").stop(true).html('<i class="fa fa-warning"></i> Cual es su numero de telefono ?').css("color", "#ef4b4b");
             ...
             $.ajax({
                 ...
                 type: 'POST',
                 data: 'tipo=archimate&&source='+source+'&medium='+medium+'&campaign='+campaign+'&term='+term+'&content='+content+'&nombre='+nombre+'&apellido='+apellido+'&empresa='+empresa+'&cargo='+cargo+'&correo='+correo+'&telefono='+telefono,
